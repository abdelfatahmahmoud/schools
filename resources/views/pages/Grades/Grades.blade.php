                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!-- add_form -->
                                            <form action="{{ route('Grades.update','tset') }}" method="POST">
                                                {{method_field('patch')}}
                                                @csrf
                                                <div class="row">
                                                    <div class="col">
                            ...
                            <div class="modal fade" id="delete{{ $grade->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!-- add_form -->
                                            <form action="{{ route('Grades.destroy','tset') }}" method="POST">
                                                {{method_field('Delete')}}
                                                @csrf
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <label for="Name" class="mr-sm-2">{{ trans('grades_trans.stage_name_ar') }}
                                                            :</label>
                                                        <input id="Name" type="text" name="Name" class="form-control" disabled="disabled"
                                                               value="{{$grade->getTranslation('Name', 'ar')}}">
                                                    </div>
                                                    <div class="col">
                                                        <label for="Name_en" class="mr-sm-2">{{ trans('grades_trans.stage_name_en') }}
                                                            :</label>
                                                        <input type="text" class="form-control" name="Name_en" disabled="disabled"
                                                               value="{{$grade->getTranslation('Name', 'en')}}">
                                                    </div>
                                                </div>
